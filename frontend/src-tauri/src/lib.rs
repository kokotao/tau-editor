...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_recovery_records,
            commands::write_recovery_record,
            commands::delete_recovery_record,
            commands::start_workspace_watch,
            commands::stop_workspace_watch,
            commands::workspace_watch_status,
            commands::resolve_workspace,
            commands::get_file_revision,
            commands::write_file_if_revision,
            commands::begin_file_write_transaction,
            commands::append_file_write_transaction_chunk,
            commands::commit_file_write_transaction,
            ...
            commands::preview_workspace_replace,
