...
async fn test_write_file_success() {
    ...
    // 调用 write_file 命令
    let result =
        file::write_file(file_path.to_string_lossy().to_string(), content.to_string()).await;
...
async fn test_write_file_empty_content() {
    ...
    let result = file::write_file(file_path.to_string_lossy().to_string(), "".to_string()).await;
...
async fn test_read_file_chunked_small_file() {
    ...
    let result =
        file_optimized::read_file_chunked(file_path.to_string_lossy().to_string(), 0, 1024).await;
...
async fn test_read_file_chunked_offset() {
    ...
    let result =
        file_optimized::read_file_chunked(file_path.to_string_lossy().to_string(), 5, 5).await;
...
async fn test_read_file_chunked_beyond_eof() {
    ...
    let result =
        file_optimized::read_file_chunked(file_path.to_string_lossy().to_string(), 1000, 100).await;
...
async fn test_read_file_chunked_nonexistent() {
    // 读取不存在的文件
    let result =
        file_optimized::read_file_chunked("/nonexistent/file.txt".to_string(), 0, 1024).await;
...
async fn test_read_file_chunked_empty_path() {
    // 空路径应返回错误
    let result = file_optimized::read_file_chunked("".to_string(), 0, 1024).await;
...
async fn test_get_file_line_count() {
    ...
    let result = file_optimized::get_file_line_count(file_path.to_string_lossy().to_string()).await;
...
async fn test_read_file_lines_from_start() {
    ...
    let result =
        file_optimized::read_file_lines(file_path.to_string_lossy().to_string(), 0, 2).await;
...
async fn test_read_file_lines_nonexistent() {
    // 读取不存在的文件
    let result = file_optimized::read_file_lines("/nonexistent/file.txt".to_string(), 0, 10).await;
